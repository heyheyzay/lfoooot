...
export default function Navigation() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white/80 backdrop-blur-md dark:border-gray-800 dark:bg-gray-900/80">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 lg:hidden bg-white dark:bg-gray-900" style={{ zIndex: 9999, height: '100vh', width: '100vw' }}>
          <div className="flex flex-col" style={{ height: '100vh', width: '100vw' }}>
            <div className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
              <Link href="/" onClick={closeMobileMenu} className="flex items-center">
                <img src={isDarkMode ? "/logo-white.svg" : "/logo-black.svg"} alt="Footfolio" style={{ width: '6rem', height: 'auto' }} />
              </Link>
              <button onClick={closeMobileMenu} className="rounded-lg p-2 text-gray-900 hover:bg-gray-100 transition-colors dark:text-white dark:hover:bg-gray-800" aria-label="Close menu">
            ...
            <div className="flex-1 overflow-y-auto bg-white py-6 dark:bg-gray-900">
              <div className="border-b border-gray-200 pb-6 dark:border-gray-700">
                ...
                >
                  Categories
                  <svg className={`h-5 w-5 transition-transform ${categoriesExpanded ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                {categoriesExpanded && (
              ...
              <div className="space-y-1 bg-white py-6 dark:bg-gray-900">
                {[
                  ...
                  <Link key={link.href} href={link.href} onClick={closeMobileMenu} className="block bg-white px-6 py-3 text-base font-semibold text-gray-900 hover:bg-gray-50 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-800">
                    {link.label}
                  </Link>
                ))}
                <button onClick={toggleDarkMode} className="flex w-full items-center gap-3 bg-white px-6 py-3 text-base font-semibold text-gray-900 hover:bg-gray-50 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-800">
                  {isDarkMode ? (
                    <>
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
